...
description: A Deep Learning Project that uses Generative Adversarial Network (GAN) and Cycle-GAN to Age or De-age
...
visible: true
---
This project is a Deep Learning project on Computer Vision. It identifies image of a human face and tries to age or de-age it. It uses Generative Adversarial Network (GAN). It trains two model simultaneously (Generator Model and Discriminator Model). After completion of training, this model can be used to complete different tasks. Such that--
